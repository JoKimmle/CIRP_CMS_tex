...
\author[a,c]{Second Author\corref{cor1}}%$\ast$}}
...
%	- focussing on workpiece monitoring, specifically material defects and user error (at setup, like wrong wrong part material, or part clamping error)
%\end{note}
